    ...
    <BaseLayout hasHeader={false} hasPadding={false} hasSidebar={false}>
      ...
      <section className="grid flex-1 h-full lg:grid-cols-2">
        <div
          ...
          style={{ backgroundImage: `url(${DentistPhoto})` }}
        ></div>

        <div className="relative grid w-full px-4 py-8 lg:px-8 place-items-center">
          <img
          ...
          <div className="flex flex-col w-full">
            <div className="flex flex-col items-center ">
              ...
              <span className="relative px-2 py-1 mt-4 text-xs font-medium rounded-lg bg-slate-100 text-slate-600 whitespace-nowrap top-1">
            ...
            {!showOtp && (
              <form className="w-full" onSubmit={handleSubmit(handleRegister)}>
                <Card className="w-full max-w-xl mx-auto mt-8 shadow">
                  <CardHeader>
                    <CardTitle>Create a new Practice Account</CardTitle>
                  </CardHeader>
                  <CardContent>
            ...
            {showOtp && (
              <form onSubmit={handleSubmit(handleVerify)}>
                <Card className="mx-auto mt-8 shadow w-fit">
                  <CardHeader>
